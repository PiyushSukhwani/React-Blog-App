...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-full mt-8 mb-8">
      <div
        className={`mx-auto w-full max-w-md bg-gray-100 rounded-xl p-10 border border-black/10`}
      >
        ...
        <h2 className="text-center text-2xl text-[#222222d6] font-bold leading-tight">
